...
export default function SignUpPage() {
  return (
    <div>
      <h1 className="text-h1 font-bold tracking-tight text-brand-navy">Create your VitalFlow account</h1>
      ...
      <div className="mt-6 rounded-card border border-warning/30 bg-warning-muted px-4 py-3 text-meta-sm text-text-primary">
        ...
        <p className="mt-1 text-text-secondary">
          Real auth is in progress. For the buildathon demo, the form below proceeds directly to
          the dashboard with a default dev session.
        </p>
      </div>

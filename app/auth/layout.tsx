  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2">
      ...
      <aside className="relative hidden flex-col justify-between border-r border-border bg-canvas p-10 md:flex">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-meta-sm text-text-secondary transition-colors hover:text-text-primary"
        >
        ...
        <div>
          ...
          <p className="mt-6 max-w-md text-body text-text-secondary">
            A financial intelligence platform for Caribbean MSMEs. Turn a bank statement into
            a lender-ready credit profile — and keep working long after the upload.
          </p>
          <div className="mt-8 max-w-md rounded-card border border-border bg-card p-5 shadow-card">
            ...
            <div className="mt-2 text-h5 font-semibold text-text-primary">
              Frontend design 1 · FutureCaribbean 2026
            </div>
